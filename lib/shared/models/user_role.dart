enum UserRole {
  ...
  bool get canApproveOrders =>
      this == UserRole.cashier || this == UserRole.admin;
  bool get canViewKitchenQueue =>
      this == UserRole.kitchen || this == UserRole.admin;
  bool get canViewBarQueue =>
      this == UserRole.bartender || this == UserRole.admin;
