class AppConstants {
  ...
  static const String brandTagline = 'Alatiris Technologies Inc.';
  ...
  // Google Integration
  static const String googleSheetsScope =
  ...
  static const String printerErrorMessage =
      'Printer connection failed. Please check your printer settings.';

  // Success Messages
  static const String orderCreatedMessage = 'Order created successfully';
  static const String orderApprovedMessage =
      'Order approved and sent to kitchen/bar';
  static const String paymentProcessedMessage =
